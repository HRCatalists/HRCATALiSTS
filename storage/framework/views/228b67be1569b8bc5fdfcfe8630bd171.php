...
<div class="border-top border-dark mb-5" id="section-organizations-<?php echo e($employeeId); ?>">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <button type="button" class="btn btn-sm btn-outline-primary toggle-edit-btn" 
                data-section="organizations" data-employee-id="<?php echo e($employeeId); ?>">Edit</button>
        </div>
    </div>
    ...
    <table class="table table-bordered text-center" id="organizationTable-<?php echo e($employeeId); ?>">
        ...
        <tbody>
            <?php $__currentLoopData = $employee->organizations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $org): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
    ...
    <button type="button" class="btn btn-sm btn-outline-success mb-3 d-none" id="addOrganizationBtn-<?php echo e($employeeId); ?>">+ Add Organization</button>
