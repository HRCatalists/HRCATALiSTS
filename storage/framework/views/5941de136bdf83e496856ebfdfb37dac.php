    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addJobForm" method="POST" action="<?php echo e(route('jobs.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row mb-3">
                        <div class="col-md-6">
...
</div><?php /**PATH C:\laragon\www\hr_catalists\resources\views\hrcatalists\ats\add_position.blade.php ENDPATH**/ ?>