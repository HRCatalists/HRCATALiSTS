...
<div class="mb-5" id="section-employment-summary-<?php echo e($employeeId ?? 'new'); ?>">
    <div class="row">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <button type="button" class="btn btn-sm btn-outline-primary toggle-edit-btn" 
                        ...
                        data-employee-id="<?php echo e($employee->id ?? 'new'); ?>">
                    Edit
                </button>
            </div>
        </div>
        ...
        <div class="col-md-9">
            <div class="mb-3">
                ...
                <input type="text" name="faculty_code" 
                       class="plain-input section-field-employment-summary-<?php echo e($employeeId ?? 'new'); ?>" 
