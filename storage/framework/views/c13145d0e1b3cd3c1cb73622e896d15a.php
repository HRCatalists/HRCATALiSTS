        ...
        <div id="content" class="flex-grow-1">
            <div class="container mt-5">
                ...
                <div class="d-flex justify-content-between align-items-center my-5">
                    <div>
                        <h2 class="dt-h2 text-capitalize"><?php echo e(ucfirst($status ?? 'All')); ?> Applicants</h2>
                        <a href="<?php echo e(route('applicants.byStatus', 'pending')); ?>" class="btn <?php echo e($status == 'pending' ? 'btn-primary' : 'btn-outline-secondary'); ?>">Pending</a>
                        <a href="<?php echo e(route('applicants.byStatus', 'hired')); ?>" class="btn <?php echo e($status == 'hired' ? 'btn-primary' : 'btn-outline-secondary'); ?>">Hired</a>
                    ...
                    <tbody>
                        ...
                        <?php if($allApplicants->count()): ?>
                            ...
                            <?php $__currentLoopData = $allApplicants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php if($applicant->status === $status): ?>
                                    <?php $hasResults = true; ?>
                                    <?php
...
<?php endif; ?><?php /**PATH C:\laragon\www\hr_catalists\resources\views/hrcatalists/ats/admin-ats-screening.blade.php ENDPATH**/ ?>