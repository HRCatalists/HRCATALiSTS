                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <?php if(isset($applicant)): ?> <!-- ✅ Ensure $applicant exists -->
                                <form action="<?php echo e(route('applicants.updateNotes', $applicant->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                                    <div class="mb-3">
                                        <label for="noteContent" class="form-label">Edit Your Notes:</label>
                                        <textarea class="form-control" id="noteContent" name="notes" rows="5"><?php echo e(old('notes', $applicant->notes ?? '')); ?></textarea>
                                    </div>
            ...
            <div id="interview" class="tab-content" style="display: none;">
                ...
                <form id="scheduleInterviewForm" method="POST" action="<?php echo e(route('events.schedule', ['id' => $applicant->id])); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="applicant_name" id="applicantNameInput" value="<?php echo e($applicant->first_name); ?> <?php echo e($applicant->last_name); ?>" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="applicantEmailInput" class="form-label">Applicant Email <span class="text-danger">*</span></label>
                        <input type="email" class="form-control" name="applicant_email" id="applicantEmailInput" value="<?php echo e($applicant->email); ?>" readonly>
                    </div>
                    <div class="row">
