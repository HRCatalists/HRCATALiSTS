    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="full_time_cc" min="0" max="30" value="{{ $def($faculty->full_time_cc ?? null) }}">
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="full_time_other_schools" min="0" max="30" value="{{ $def($faculty->full_time_other_schools ?? null) }}">
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="part_time_cc" min="0" max="30" value="{{ $def($faculty->part_time_cc ?? null) }}">
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="part_time_other_schools" min="0" max="30" value="{{ $def($faculty->part_time_other_schools ?? null) }}">
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="checkbox" name="course_module" value="5" {{ isset($faculty) && $faculty->course_module ? 'checked' : '' }}>
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="checkbox" name="workbook_lab_manual" value="5" {{ isset($faculty) && $faculty->workbook_lab_manual ? 'checked' : '' }}>
        </td>
        <td class="text-center">5 pts</td><td></td>
      </tr>
      <tr>
        ...
        <td class="text-center">
          <input type="checkbox" name="research_articles" value="2" {{ isset($faculty) && $faculty->research_articles ? 'checked' : '' }}>
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="checkbox" name="journal_editorship" value="2" {{ isset($faculty) && $faculty->journal_editorship ? 'checked' : '' }}>
        </td>
        <td class="text-center">2 pts</td><td></td>
      </tr>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="checkbox" name="participation_chairman" value="5" {{ isset($faculty) && $faculty->participation_chairman ? 'checked' : '' }}>
        </td>
        <td class="text-center">5 pts</td><td></td>
      </tr>
      <tr>
        ...
        <td class="text-center">
          <input type="checkbox" name="participation_member" value="3" {{ isset($faculty) && $faculty->participation_member ? 'checked' : '' }}>
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="resource_person_within" value="{{ $def($faculty->resource_person_within ?? null) }}">
        </td>
      ...
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="resource_person_outside" value="{{ $def($faculty->resource_person_outside ?? null) }}">
        </td>
        <td class="text-center">1 pt/activity</td><td></td>
      </tr>
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="membership_officer_accreditor" value="{{ $def($faculty->membership_officer_accreditor ?? null) }}">
        </td>
        <td class="text-center">2 pts/year</td><td></td>
      </tr>
      <tr>
        ...
        <td class="text-center">
          <input type="number" name="membership_member" value="{{ $def($faculty->membership_member ?? null) }}">
        </td>
        <td class="text-center">1 pt/year</td><td></td>
      </tr>
