        ...
        <div id="sidebar" class="shadow">
            <ul class="list-unstyled components">
                <li class="d-flex align-items-center pe-5">
                    ...
                    <a href="{{ route('ems-dashboard') }}" class="nav-link px-0 align-middle">
                ...
                <li class="d-flex align-items-center pe-5">
                    ...
                    <a href="{{ route('ems-calendar') }}" class="nav-link px-0 align-middle">
                    ...
                    <ul class="collapse flex-column ms-1" id="employee" data-bs-parent="#menu">
                        ...
                        <li class="department">
                            ...
                            <ul class="collapse flex-column" id="department" data-bs-parent="#menu">
                                ...
                                <li>
                                    <a href="{{ route('ems-dept-basicEd') }}" class="nav-link px-0"> <span class="sidebar-effect">Non-Teaching</span> </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="d-flex align-items-center pe-5">
                    ...
                    <a href="{{ route('ems-logs') }}" class="nav-link px-0 align-middle">
                ...
                <li class="d-flex align-items-center mt-3 pe-5">
                    <a href="{{ route('main-menu') }}" class="fw-bold ms-3 sidebar-effect">SWITCH TO ATS</a>
                </li>
            </ul>
        </div>
        <!-- End of Sidebar -->