<x-admin-ems-layout>
    ...
    <x-slot:title>
        Columban College Inc. | Dashboard
    </x-slot:title>
            ...
            <div id="sidebar" class="shadow">
                <ul class="list-unstyled components">
                    <li class="d-flex align-items-center pe-5">
                        ...
                        <a href="admin-ems-db.html" class="nav-link px-0 align-middle">
                    ...
                    <li class="d-flex align-items-center pe-5">
                        ...
                        <a href="admin-ems-cl.html" class="nav-link px-0 align-middle">
                    ...
                    <li class="d-flex align-items-center employee pe-5">
                        ...
                        <ul class="collapse flex-column ms-1" id="employee" data-bs-parent="#menu">
                            <li class="mt-2">
                                <a href="admin-ems-emp.html" class="nav-link px-0"> <span class="sidebar-effect">Employee List</span> </a>
                            </li>
                            ...
                            <li class="department">
                                ...
                                <ul class="collapse flex-column" id="department" data-bs-parent="#menu">
                                    <li>
                                        <a href="admin-ems-dept-coa.html" class="nav-link px-0"> <span class="sidebar-effect">College of Architecture</span> </a>
                                    </li>
                                    <li>
                                        <a href="admin-ems-dept-cased.html" class="nav-link px-0"> <span class="sidebar-effect">College of Arts & Science and Education</span> </a>
                                    </li>
                                    <li>
                                        <a href="admin-ems-dept-cba.html" class="nav-link px-0"> <span class="sidebar-effect">College of Business and Accountancy</span> </a>
                                    </li>
                                    <li>
                                        <a href="admin-ems-dept-ccs.html" class="nav-link px-0"> <span class="sidebar-effect">College of Computer Studies</span> </a>
                                    </li>
                                    <li>
                                    <a href="admin-ems-dept-coe.html" class="nav-link px-0"> <span class="sidebar-effect">College of Engineering</span> </a>
                                    </li>
                                    <li>
                                        <a href="admin-ems-dept-con.html" class="nav-link px-0"> <span class="sidebar-effect">College of Nursing</span> </a>
                                    </li>
                                    <li>
                                        <a href="admin-ems-dept-basicEd.html" class="nav-link px-0"> <span class="sidebar-effect">College of Basic Education</span> </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="d-flex align-items-center pe-5">
                        ...
                        <a href="admin-ems-policy.html" class="nav-link px-0 align-middle">
                    ...
                    <li class="d-flex align-items-center pe-5">
                        ...
                        <a href="admin-ems-logs.html" class="nav-link px-0 align-middle">
                    ...
                    <li class="d-flex align-items-center mt-3 pe-5">
                        <a href="admin-ats-db.html" class="fw-bold ms-3 sidebar-effect">SWITCH TO ATS</a>
                    </li>
                </ul>
            </div>
            <!-- End of Sidebar -->
