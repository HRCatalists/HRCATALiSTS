...
<div class="border-top border-dark mb-5" id="section-licenses-{{ $employeeId }}">
    ...
    <table class="table table-bordered text-center" id="licensesTable-{{ $employeeId }}">
        ...
        <tbody>
            @foreach ($employee->licenses as $i => $license)
                <tr>
    ...
    <button type="button" class="btn btn-sm btn-outline-success mb-3 d-none" id="addLicenseBtn-{{ $employeeId }}">+ Add License</button>
</div>