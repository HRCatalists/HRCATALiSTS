...
<div class="border-top border-dark mb-5" id="section-organizations-{{ $employeeId }}">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div>
            <button type="button" class="btn btn-sm btn-outline-primary toggle-edit-btn" 
                data-section="organizations" data-employee-id="{{ $employeeId }}">
                Edit
            </button>
        </div>
    </div>
    ...
    <button type="button" class="btn btn-sm btn-outline-success mb-3 d-none" id="addOrganizationBtn-{{ $employeeId }}">
        + Add Organization
    </button>
</div>